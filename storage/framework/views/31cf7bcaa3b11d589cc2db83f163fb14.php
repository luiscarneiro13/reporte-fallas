...
<?php $__env->startSection('content_header'); ?>
    ...
    <small><?php echo e($division->name); ?></small>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('admin.sucursal.divisions.update', $division)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <input type="hidden" name="id" value="<?php echo e($division->id); ?>">
                <div class="row">
...
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Nombre','value' => ''.e($division->name).'']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Descripción','value' => ''.e($division->description).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale5d826ae10df3aa87f8449f474c11664)): ?>
<?php $attributes = $__attributesOriginale5d826ae10df3aa87f8449f474c11664; ?>
...
<?php endif; ?>
                ...
                <div class="row mt-5">
                    <a href="<?php echo e(route('admin.sucursal.divisions.index')); ?>" class="btn-sm mr-3 btn-default" type="submit"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\reportefallas\resources\views/V1/AdminBranch/Divisions/edit.blade.php ENDPATH**/ ?>