...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base-data-table-search','data' => ['title' => 'Equipos','items' => $equipment,'headers' => $headers,'urlBtnAdd' => ''.e(route('admin.sucursal.equipment.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Equipos','items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($equipment),'headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($headers),'urlBtnAdd' => ''.e(route('admin.sucursal.equipment.create')).'']); ?>
         <?php $__env->slot('body', null, []); ?> 
            <?php $__empty_1 = true; $__currentLoopData = $equipment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td><?php echo e($item->internal_code); ?></td>
                    <td><?php echo e($item->placa); ?></td>
                    <td><?php echo e($item->vehicle_model); ?></td>
                    <td><?php echo e($item->model_year); ?></td>
                    <td><?php echo e($item->color); ?></td>
                    <td><?php echo e($item->lastProject?->name); ?></td>
                    <td>
                        <div class="input-group" style="cursor:pointer;">
                            <div>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('admin.sucursal.equipment.edit', $item)); ?>">
                                    ...
                                    <form class="formEliminar"
                                        action="<?php echo e(route('admin.sucursal.equipment.destroy', $item)); ?>" method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/V1/AdminBranch/Equipment/index.blade.php ENDPATH**/ ?>