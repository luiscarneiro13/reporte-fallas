...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-header">
            <a href="<?php echo e(route('customer.create')); ?>" class="btn btn-sm btn-primary float-right">Nuevo</a>
        </div>
                            ...
                            <div class="input-group" style="cursor:pointer;">
                                <div>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="<?php echo e(route('customer.edit', $item)); ?>">
                                            <i class="fa fa-edit">&nbsp;</i>
                                            Editar
                                        </a>

                                        <a class="dropdown-item" href="<?php echo e(route('customer.show', $item)); ?>">
                                            <i class="fa fa-eye">&nbsp;</i>
                                            Ver datos
                                        </a>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Eliminar Cliente')): ?>
                                            <form class="formEliminar" data-nombre="<?php echo e($item->email); ?>"
                                                action="<?php echo e(route('customer.destroy', $item)); ?>" method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\reportefallas\src\resources\views/Customers/index.blade.php ENDPATH**/ ?>