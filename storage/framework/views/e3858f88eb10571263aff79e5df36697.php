...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base-data-table-search','data' => ['title' => 'Empleados Administradores','items' => $employees,'headers' => $headers,'urlBtnAdd' => ''.e(route('admin.sucursal.usuarios.administradores.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Empleados Administradores','items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($employees),'headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($headers),'urlBtnAdd' => ''.e(route('admin.sucursal.usuarios.administradores.create')).'']); ?>
                            ...
                            <div>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item"
                                        href="<?php echo e(route('admin.sucursal.usuarios.administradores.edit', $item)); ?>">
                                    ...
                                    <form class="formEliminar"
                                        action="<?php echo e(route('admin.sucursal.usuarios.administradores.destroy', $item)); ?>"
                                        method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\reportefallas\resources\views/AdminBranch/Usuarios/Administradores/index.blade.php ENDPATH**/ ?>