...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base-data-table-search','data' => ['title' => 'Marcas de artículos','items' => $brands,'headers' => $headers,'urlBtnAdd' => ''.e(route('admin.sucursal.brands.create')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Marcas de artículos','items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($brands),'headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($headers),'urlBtnAdd' => ''.e(route('admin.sucursal.brands.create')).'']); ?>
                        ...
                        <div class="input-group" style="cursor:pointer;">
                            <div>
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="<?php echo e(route('admin.sucursal.brands.edit', $item)); ?>">
                                    ...
                                    <form class="formEliminar" action="<?php echo e(route('admin.sucursal.brands.destroy', $item)); ?>"
                                        method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\reportefallas\resources\views/AdminBranch/Brands/index.blade.php ENDPATH**/ ?>