...
@section('content_header')
    <h1>Crear status de repuestos</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.sucursal.spare.part.statuses.store') }}" method="POST">
                @csrf
                @if ($back_url)
                ...
                <div class="row mt-5">
                    <a href="{{ request()->back_url ?? route('admin.sucursal.spare.part.statuses.index') }}"
