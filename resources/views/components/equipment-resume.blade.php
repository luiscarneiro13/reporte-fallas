    ...
    <div class="card-body">
        <div id="table2_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                ...
                <div class="col-sm-12">
                    <label>
                        <div class="form-inline justify-content-between align-items-center">
                            <h4 class="mr-3">{{ $title ?? 'Equipos' }}</h4>
                            @if (isset($urlBtnAdd))
            ...
            <div class="row mb-2 align-items-end">
                ...
                <x-select label="Activo/Inactivo" name="active" :items="['' => 'Todos', '1' => 'Activo', '0' => 'Inactivo']"
                    class="col-md-3" />

                <x-input-custom name="internal_code" id="internalCodeInput" class="col-md-3" label="Código interno"
                    noMarginTop />
    ...
    <script>
        $(document).ready(function() {
            ...
            selectParams.forEach(function(paramName) {
                ...
                $select.val(paramValue !== null ? paramValue : ($select.find('option').first().val()))
                    .trigger('change');
            });
