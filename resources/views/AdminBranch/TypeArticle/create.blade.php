...
@section('content_header')
    <h1>Nueva descripción de artículo</h1>
@stop
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('admin.sucursal.type.articles.store') }}" method="POST">
                @csrf
                @if ($back_url)
                    <input type="hidden" name="back_url" value="{{ $back_url }}">
                @endif
                <div class="row">
                    <x-adminlte-input name="name" label="Nombre" placeholder="Ej: aceite, filtro, etc"
