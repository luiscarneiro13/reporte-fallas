...
@section('content')
    ...
    <x-equipment-resume title="Equipos" :items="$equipment" :headers="$headers"
        :urlBtnAdd="route('admin.sucursal.equipment.create')" titlePrint="Listado de equipos"
        :urlPrint="route('equipment.impAll')" :urlExcel="route('equipment.excel')" titleExcel="Exportar a Excel"
        :projects="$projects" :sortBy="$sortBy ?? null" :sortDir="$sortDir ?? 'asc'">
        <x-slot name="body">
