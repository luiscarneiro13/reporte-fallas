    ...
    public function up(): void
    {
        $sql = "
            ...
            select
                ...
                `f`.`executor_external_id` AS `executor_external_id`,
                concat(`e_executor_external`.`identification_number`,' ',`e_executor_external`.`last_name`,' ',`e_executor_external`.`first_name`) AS `executor_external_name`,
            ...
            from
                ...
                left join `employees` `e_executor_external` on((`f`.`executor_external_id` = `e_executor_external`.`id`));
            ";
