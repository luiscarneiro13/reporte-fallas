<nav
    ...
    <ul class="navbar-nav w-100">
        ...
        <div class="row w-100">
            <div class="col-md-2">
                <?php echo $__env->yieldContent('tasa_del_dia'); ?>
            </div>
            <div class="col-md-2">
                <?php echo $__env->yieldContent('tasa_promedio'); ?>
            </div>
...
<?php /**PATH D:\laragon\www\reportefallas\laravel\resources\views/vendor/adminlte/partials/navbar/navbar.blade.php ENDPATH**/ ?>