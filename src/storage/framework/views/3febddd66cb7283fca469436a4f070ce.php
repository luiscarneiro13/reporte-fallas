            ...
            <form action="<?php echo e(route('admin.sucursal.projects.update', $project)); ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        ...
                        <?php echo e(Form::select('customer_id', $customers, $project->customer_id, ['class' => 'select2 form-control'])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => '','value' => ''.e($project->name).'']); ?>
...
<?php endif; ?>
                    ...
                    <div class="col-md-5">
                        ...
                        <?php echo e(Form::select('division_id', $divisions, $project->division_id, ['class' => 'select2 form-control'])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => '','value' => ''.e($project->contract_number).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale5d826ae10df3aa87f8449f474c11664)): ?>
<?php $attributes = $__attributesOriginale5d826ae10df3aa87f8449f474c11664; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => '','value' => ''.e($project->geographic_area).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale5d826ae10df3aa87f8449f474c11664)): ?>
<?php $attributes = $__attributesOriginale5d826ae10df3aa87f8449f474c11664; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => '']); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\reportefallas\src\resources\views/V1/AdminBranch/Projects/edit.blade.php ENDPATH**/ ?>