...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?php echo e(route('admin.sucursal.customers.update', $customer)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Nombre','value' => ''.e($customer->name).'']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Email','value' => ''.e($customer->email).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale5d826ae10df3aa87f8449f474c11664)): ?>
<?php $attributes = $__attributesOriginale5d826ae10df3aa87f8449f474c11664; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Teléfono','value' => ''.e($customer->phone).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale5d826ae10df3aa87f8449f474c11664)): ?>
<?php $attributes = $__attributesOriginale5d826ae10df3aa87f8449f474c11664; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['placeholder' => 'Dirección','value' => ''.e($customer->address).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale5d826ae10df3aa87f8449f474c11664)): ?>
<?php $attributes = $__attributesOriginale5d826ae10df3aa87f8449f474c11664; ?>
...
<?php endif; ?>
                ...
                <div class="row mt-5">
                    <a href="<?php echo e(route('admin.sucursal.customers.index')); ?>" class="btn-sm mr-3 btn-default" type="submit"
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\reportefallas\src\resources\views/V1/AdminBranch/Customers/edit.blade.php ENDPATH**/ ?>